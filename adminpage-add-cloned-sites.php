...
if ( is_multisite() ) {
 ...
 if ($subdomain_install == true) {print "subdomain install";} else { print "subfolder install";}
}
...
<div class="wrap">
    ...
    <?php wp_nonce_field('go_do_magic','nonce_field'); ?>
		...
		*/ ?>
        ...
        <p>
		<label for="acswpmu_domainmap" class="checkboxlabel"><?php _e("Automatically domainmap the new sites:", 'acswpmu_trdom' ); ?></label>
        <input type="checkbox" id="acswpmu_domainmap" name="acswpmu_domainmap" data-on="Of course, that is why I got this plugin" data-off="No, I will do it manually" checked="checked" />
        </p>       
<?php /*
        <p>
...
*/ ?>
		...
		<?php _e('Note: when leaving \'site_name\' empty, the new_site_url will be used as the site name.', 'acswpmu_trdom' ) ?>
		<hr/>
		</div>
		<p class="submit">
