...
Update: Now also works for both subdomain as subdirectory network installs.
...
= How does it handle links to images in posts? =

Ehm, not. In the newly cloned sites they will still link to the url of the image in the template site.
I will make an option later to also duplicate all images and change the links to them, however in most cases you will change the images anyway.
An other advantage is the space and bandwith you safe when not duplicating the images in post..
